...
timestamp = 0
cv2.namedWindow("YOLOv8 Inference: Pose Detection - Press Q to Quit", cv2.WINDOW_NORMAL)
while True:
    ...
    cv2.imshow("YOLOv8 Inference: Pose Detection - Press Q to Quit", annotated_frame)
